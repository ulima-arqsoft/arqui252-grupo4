...
- *Gestión de Usuarios:* Gestiona los perfiles de usuario, roles (comprador/vendedor) e historial de transacciones. La autenticación y el registro de nuevos usuarios son delegados al servicio externo Auth0 para garantizar un entorno seguro y profesional.
...
- *Sistema de Pagos:* Módulo de alta seguridad que procesa las transacciones financieras. Se integra con el agregador de pagos Culqi, que a su vez da acceso a tarjetas de crédito/débito y billeteras digitales locales (como Yape y Plin) a través de una sola conexión.
