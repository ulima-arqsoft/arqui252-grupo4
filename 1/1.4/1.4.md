...
| Categoría            | Encargado        | Responsabilidad                                      | Interés en la Arquitectura |
|-----------------------|------------------|------------------------------------------------------|-----------------------------|
| Representante Externo | Empresas de logística | Asegurar envíos de juegos físicos.                | Que el sistema soporte integración con sistemas de tracking/logística. |
| Integrador            | Diego Meza       | Desarrollar APIs para la comunicación con empresas de envíos. | Que los módulos externos puedan cambiarse con bajo impacto en el código. |
| Usuario               | N/A              | Recibir sus juegos retro comprados.                 | Que el sistema sea confiable y ofrezca seguimiento de envíos. |

---

## Módulo 6: Comunidad y Reseñas
| Categoría                  | Encargado        | Responsabilidad                                         | Interés en la Arquitectura |
|-----------------------------|------------------|---------------------------------------------------------|-----------------------------|
...
## Módulo 7: Análisis de Datos y Reportes
| Categoría         | Encargado        | Responsabilidad                                      | Interés en la Arquitectura |
|-------------------|------------------|------------------------------------------------------|-----------------------------|
